...
from core.percuma_password_checker import *
from core.percuma_realm import *
from core.percuma_session import *
...
if __name__ == "__main__":
    start_logging()
    components.registerAdapter(PercumaSession, SSHAvatar, session.ISession)
